...
// Source: github.com/blablatov/mtls-grpc-gateway/gw-mtls-proto (interfaces: ProductInfoClient)

// Package mock_gw_mtls_proto is a generated GoMock package.
...
func (m *MockProductInfoClient) AddProduct(arg0 context.Context, arg1 *pb.Product, arg2 ...grpc.CallOption) (*wrapperspb.StringValue, error) {
	//m.ctrl.T.Helper()
...
func (m *MockProductInfoClient) GetProduct(arg0 context.Context, arg1 *wrapperspb.StringValue, arg2 ...grpc.CallOption) (*pb.Product, error) {
	//m.ctrl.T.Helper()
	varargs := []interface{}{arg0, arg1}
	for _, a := range arg2 {
		varargs = append(varargs, a)
